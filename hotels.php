<?php include('connexion.php');
  ...
  <html>
    ...
    <body style="background-color: skyblue ;"><br><br>
          <div class="banner" style="color: white; text-align: center; height: 100vh; background-size: cover; background-position: 50%; display: flex; align-items: center; justify-content: center; background-image: url('img/ban.jpg'); width:100%; height: 350px; ">
       <div class="banner-content">
          ...
          <div class="body" style="background-color:#FFF; width: 960px; margin: 10px auto; height: auto; position: relative;">
           ...
           <div style="margin: 100px;"><br><br>
              ...
              <h1 style="color: skyblue;"><center><i></i>Hôtels en COTE D'IVOIRE</center></h1><br><br><br>
                <?php
                  $n=1;
                  $v2="SELECT 
                    nom,
                ...
                ?>
                  ...
                  <div style="text-align:justify;">
                   <center> <p style="color:blue;"><?php echo nl2br(htmlspecialchars($info_site['nom'])); ?> dans la ville de <?php echo nl2br(htmlspecialchars($info_site['libelle'])); ?></p></center><br><br>
